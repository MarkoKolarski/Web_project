...
VALUES ('Marko', 'Kolarski', 'user1', 'mkolarski@gmail.com', 'lozinka1', '2023-03-18 18:30:00', 'C:/Users/Marko Kolarski/Pictures/Saved Pictures/profilna_slika1.jpg', 'opis1', 1);
INSERT INTO KORISNIK (ime, prezime, korisnicko_ime, mejl_adresa, lozinka, datum_rodjenja, profilna_slika, opis, uloga)
VALUES ('Nikola', 'Nikolic', 'user2', 'nikolanikolic@gmail.com','lozinka2', '1923-03-18 17:30:00', 'C:/Users/Marko Kolarski/Pictures/Saved Pictures/profilna_slika2.jpg','opis2', 0);
INSERT INTO KORISNIK (ime, prezime, korisnicko_ime, mejl_adresa, lozinka, datum_rodjenja, profilna_slika, opis, uloga)
VALUES ('Marko', 'Markovic', 'user3', 'markomarkovic@gmail.com','lozinka3', '2023-09-25 11:30:00', 'C:/Users/Marko Kolarski/Pictures/Saved Pictures/profilna_slika3.jpg','opis3',2);

INSERT INTO AUTOR (id, aktivan) VALUES (1, FALSE);
--INSERT INTO AUTOR (id, aktivan) VALUES (3, FALSE);

INSERT INTO POLICA (naziv, primarna) VALUES ('polica1', TRUE);
INSERT INTO POLICA (naziv, primarna) VALUES ('polica2', FALSE);
INSERT INTO POLICA (naziv, primarna) VALUES ('polica3', TRUE);

INSERT INTO KORISNIK_POLICA (korisnik_id, police_id) VALUES (2, 1);
INSERT INTO KORISNIK_POLICA (korisnik_id, police_id) VALUES (2, 2);
INSERT INTO KORISNIK_POLICA (korisnik_id, police_id) VALUES (2, 3);
