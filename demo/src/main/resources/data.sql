...
INSERT INTO KORISNIK (id, ime, prezime, korisnicko_ime, mejl_adresa, lozinka, datum_rodjenja, profilna_slika, opis, uloga)
VALUES (2, 'Nikola', 'Nikolic', 'user2', 'nikolanikolic@gmail.com','lozinka2', '1923-03-18 17:30:00', 'nema.jpg','opis2', 1);
INSERT INTO KORISNIK (id, ime, prezime, korisnicko_ime, mejl_adresa, lozinka, datum_rodjenja, profilna_slika, opis, uloga)
...
INSERT INTO KNJIGA (id, naslov, ocena, naslovna_fotografija, ISBN, datum_objavljivanja, broj_strana, opis, stavka_polica2_id)
VALUES (1, 'Mali_princ', 9, 'slika.jpg', '123', '2023-04-15 14:30:00', 123, 'Opis1', 1);
INSERT INTO KNJIGA (id, naslov, ocena, naslovna_fotografija, ISBN, datum_objavljivanja, broj_strana, opis, stavka_polica2_id)
VALUES (2, 'Hajduci', 8, 'slika2.jpg', '233', '2018-07-15 9:30:00', 253, 'Opis2', 2);
